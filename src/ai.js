...
import img2 from './images/skillf.jpg'
import im from './images/ai3.png'
...
const Newai =() =>{
  ...
  return (
    ...
    <div className="bg-[#282a35]">
      <header className="bg-[#282a35] border border-gray-500 rounded-2xl ">
        <div className="container mx-auto py-4 px-5 flex justify-between items-center">
          ...
          <img className=' mt-2  h-16 w-18 mr-auto ml-8 mb-2' src={img2} alt="/" />
          <nav>
    ...
    <header className="  text-4xl   items-center mx-auto pl-4 pt-4 pr-4 bg-[#282a35] ">
      <div className="sm:h-screen h-4 bg-white rounded-3xl mx-auto border-radius-[30px]">
        <h1 className=" pl-8 pt-6 font-medium text-[#1e7f17]" id={"About the course"}>What is Artificial intelligence ?</h1>
        <p className="lg:text-2xl md:text-xl sm:text-lg text-lg pl-14 mt-6">Artificial intelligence (AI) is the ability of a computer or a robot controlled by a computer to do tasks that are usually done by humans because they require human intelligence and discernment. Although there are no AIs that can perform the wide variety of tasks an ordinary human can do, some AIs can match humans in specific tasks. </p>
      <h2 className="font-medium mt-8  pl-8 mb-6 text-[#1e7f17]"> Applications</h2>
      <img className=' pt-8 sm:h-96 h-auto mx-auto ' src={img} alt="/" />
      ...
      <div className="h-screen items-center bg-white mx-auto  mt-4 rounded-3xl border-radius-[30px]">
        ...
        <img class=' sm:h-2/3  h-1/4    mx-auto  mt-20 w-1/2' src={img1} alt="/" />
    ...
    <p className="pl-14"><a href="https://www.youtube.com/@Telusko" className="hover:text-green-500 hover:bg-gray-700 rounded-lg">3. Telusko</a></p>
        ...
        <div className="pl-14 text-2xl  ">
        <p className="pl-14"><a href="https://www.w3schools.com/ai" className="hover:text-green-500 hover:bg-gray-700 rounded-lg">1. W3schools</a></p>
    <p className="pl-14"><a href="https://www.javatpoint.com/artificial-intelligence-ai" className="hover:text-green-500 hover:bg-gray-700 rounded-lg">2. javatpoint</a></p>
    <p className="pl-14"><a href="https://www.geeksforgeeks.org/artificial-intelligence-an-introduction" className="hover:text-green-500 hover:bg-gray-700 rounded-lg">3. geeksforgeeks</a></p>
      ...
      <div className="h-screen items-center bg-white mt-4  rounded-3xl mx-auto border-radius-[30px]">
        ...
        <img className=' sm:h-2/3  h-1/4    w-full  mx-auto  mt-2' src={im}   alt="/" />
    ...
    <footer className="bg-[#282a35] py-8 h-[320px] border-radius-[30px]">
      <div className="container mx-auto flex justify-between">
        <div className="flex flex-col">
          <img className="h-16 w-16  mr-auto ml-8 mb-2 mt-2 " src={img2} alt="Logo" />
